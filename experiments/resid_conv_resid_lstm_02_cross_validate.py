...
def model_constructor(dtype='float32'):
    from src.models.resid_conv_resid_lstm import ResidConvResidLSTM
    predictor = ResidConvResidLSTM(units=32, layers=[3, 6, 2, 0], pool='max') ## was 64
    from src.models.binding_model import BindingModel, Regularizer
    from src.models.optimizer import RMSprop, Nesterov, SGD
    optimizer = SGD(nu=0.001, conditioner=RMSprop(), momentum=Nesterov(), minibatch_size=128, convergence_sample=500)
